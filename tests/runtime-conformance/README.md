...
| `operating-systems/alpine/3.22` | Alpine 3.22 identity, busybox, `apk`, Bash, sudo, curl/wget, Git, Python 3, archive tools, OpenSSH server, musl compatibility packages (`gcompat`, `libstdc++`, `libgcc`), localized README, root/devbox entrypoint order |
